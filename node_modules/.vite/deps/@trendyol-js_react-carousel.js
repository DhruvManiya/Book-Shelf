...
var p = function(t2) {
  ...
  var s2 = e2 > n2;
  return r2 ? { left: s2, right: s2 } : { left: s2 && 0 !== i2, right: s2 && i2 + n2 < e2 };
};
...
var b = function(t2) {
  var e2 = (0, import_react.useState)("undefined" == typeof window ? 0 : window.innerWidth), n2 = e2[0], o2 = e2[1];
...
var x = function(i2) {
  ...
  f2.dynamic && (0, import_react.useEffect)(function() {
    ...
    E2(t2), x2.current = t2, K < f2.pageCount && B && (null == B ? void 0 : B.length) < f2.children.length && (H(h.Right), Y(K + 1));
  ...
  var G = function() {
    ...
    if (!(S.isSliding || t2 === h.Right && !z.right || t2 === h.Left && !z.left)) {
      ...
      }(D, f2.slide, n2.length, t2), i3 = "number" == typeof e2 ? e2 - D : -1 * t2, o3 = f2.infinite ? U ? function(t3, e3, n3, r3, i4, o4) {
      ...
      f2.infinite && t2 === h.Right && (E2(o3), x2.current = o3), N({ transform: S.transform + Math.abs(i3) * g(T2, f2.slide, t2), transition: f2.transition, isSliding: true }), W(U && "number" == typeof e2 ? e2 : r2), X(p({ itemCount: n2.length, itemsToShow: f2.show, infinite: f2.infinite, current: r2, hideArrows: f2.hideArrows })), setTimeout(function() {
        if (f2.infinite) {
          var n3 = U ? function(t3, e3, n4) {
            return n4 === h.Left ? t3.slice(0, e3) : t3.slice(e3);
          }(t2 === h.Right ? x2.current : o3, function(t3, e3, n4, r3) {
            return "number" == typeof t3 ? r3 === h.Right ? t3 - e3 + 1 : n4 : -1 * r3;
  ...
  return import_react.default.createElement("div", s({}, f2.a11y, { "data-testid": "carousel", tabIndex: 0 }, f2.useArrowKeys ? { onKeyDown: function(t2) {
    ...
    return H(h.Left);
  } }, null !== (o2 = f2.leftArrow) && void 0 !== o2 ? o2 : import_react.default.createElement(m, { direction: "left" })), import_react.default.createElement(k, s({}, f2, { transition: S.transition, items: x2.current, transform: S.transform, slideCallback: function(t2) {
    H(t2);
    ...
    return H(h.Right);
  }, ref: F }, null !== (a2 = f2.rightArrow) && void 0 !== a2 ? a2 : import_react.default.createElement(m, { direction: "right" })), U && import_react.default.createElement(C, { factory: f2.navigation, items: f2.children, current: D, onClick: function(t2) {
...
var A = function(n2) {
  var i2 = n2.children, s2 = n2.className, a2 = n2.leftIcon, l2 = n2.rightIcon, u2 = (0, import_react.useRef)(null), c2 = (0, import_react.useState)(false), f2 = c2[0], d2 = c2[1], m2 = (0, import_react.useState)({ startX: 0, scrollLeft: 0 }), v2 = m2[0], g2 = m2[1], p2 = function() {
    ...
    null !== t2 && (Object.defineProperty(u2, "current", { value: t2 }), _2(p2()), t2.addEventListener("scroll", b2));
